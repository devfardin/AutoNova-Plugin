...
class AdminPage
{
    ...
    function render_admin_page()
    {
        ...
        <div class="wrap">
            ...
            <div class="autonova-card-wrapper">
                ...
                <div class="autonova-card">
                    ...
                    <form method="post" action="options.php">
                        ...
                        <div class="autonova-field">
                            ...
                            <textarea name="autonova_options[whatsapp_predefined_message]"
                                placeholder="Hello! I'm interested in..."><?php echo esc_textarea($options['whatsapp_predefined_message'] ?? ''); ?></textarea>
                        </div>
